...
INSERT INTO "new_config_gateway" ("apiKey", "clientApiUrl", "createdAt", "description", "id", "integration", "logLevel", "readQueueInterval", "serialPort", "uid", "updatedAt", "wsConnection") SELECT "apiKey", "clientApiUrl", "createdAt", "description", "id", "integration", "logLevel", "readQueueInterval", "serialPort", "uid", "updatedAt", "wsConnection" FROM "config_gateway";
